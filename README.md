...
| 样本类型 | 字数 | 改写前 | 改写后 | 降幅 |
|---|---|---|---|---|
| 🎓 学术论文 | ~280 | **100/100** 🔴 VERY HIGH | **35/100** 🟢 LOW | **−65** |
| 💬 通用文本 | ~250 | **100/100** 🔴 VERY HIGH | **35/100** 🟢 LOW | **−65** |
| 🌸 小红书风格 | ~280 | **100/100** 🔴 VERY HIGH | **41/100** 🟡 MEDIUM | **−59** |
| 📝 **长篇博客（v5 特化）** | **~1364** | **96/100** 🔴 VERY HIGH | **41/100** 🟡 MEDIUM | **−55** |

> 短样本平均降低 **63 分**，长篇 (1300+ 字) 降低 **55 分**。所有数值用 `seed=42` + `--best-of-n 10` 可复现。

零注册、零付费、零联网、零 LLM、零 API Key —— 纯 Python 规则 + LR 集成，本地 5-50 秒跑完。

---

## 改写前后对比

### 🎓 学术论文（VERY HIGH → LOW，**降 65 分**）

**改写前** 🔴 100分（密集 AI 写作特征 — `随着...的不断发展` `多维度` `全方位` `值得注意的是` `赋能` `深度融合` `综上所述` `不难发现` `由此可见`）：
> **随着**信息技术**的不断发展**，人工智能在教育领域的应用正在日益深化，呈现出**多维度**、**全方位**的发展态势。本研究旨在探讨人工智能技术在个性化学习中的应用机制及其效果，具有重要的理论意义和实践价值。
>
> **值得注意的是**，近年来人工智能**赋能**教育已成为学界关注的焦点。研究表明，智能化系统通过**深度融合**大数据分析与机器学习算法，能够**全方位**地评估学生学习状况，从而实现真正意义上的因材施教。**不难发现**，这种新型教学模式正在推动教育生态的深度变革。
>
> **综上所述**，**随着**技术**的不断发展**，人工智能必将在教育领域发挥越来越重要的作用，为构建高质量教育体系提供有力支撑。**由此可见**，深入研究该领域具有广阔的发展前景。

**改写后** 🟢 35分（套话清掉，节奏破开）：
> 现在，人工智能在教育领域的应用正在日益深化，呈现出多个层面、多维度的发展态势。本研究尝试探讨人工智能技术在个性化学习中的应用机制及其效果，具有重要的理论意义和实践价值。
>
> 这几年人工智能助力教育已成为学界关注的焦点。从已有审视来看，智能化系统通过结合大数据分析与机器学习算法，能够各维度地评估学生学习状况，于是实现真正意义上的因材施教。

### 💬 通用文本（VERY HIGH → LOW，**降 65 分**）

**改写前** 🔴 100分：
> **综上所述**，人工智能技术在教育领域具有重要的应用价值和广阔的发展前景。**值得注意的是**，**随着**技术**的不断发展**，AI 将在个性化学习、智能评估和自适应教学等方面发挥越来越重要的作用。
>
> **首先**，人工智能能够**助力**教师进行精准教学。通过大数据分析和深度学习算法，AI 系统可以**全方位**地了解每个学生的学习特点，从而实现真正意义上的因材施教。
...
### 🌸 社交媒体 → 小红书风格（VERY HIGH → MEDIUM，**降 59 分**）

**改写前** 🔴 100分：
> **在当今**快节奏的生活中，时间管理对于每个人来说都具有**至关重要**的意义。**值得注意的是**，通过合理规划和科学管理时间，不仅能够**显著**提升工作效率，更能够实现工作与生活的完美平衡，**从而全方位**提升整体生活质量。
>
> **首先**，制定明确的目标是时间管理的基础。一个清晰的目标能够**赋能**我们的日常决策，帮助我们更好地分配时间和精力。

**改写后** 🟡 41分（自动先 humanize 去 AI 词，再加入小红书风格要素）：
> 姐妹们🎀！今天必须分享一下～
>
