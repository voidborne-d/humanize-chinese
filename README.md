...
**三款测试样本平均降低 73 分**（学术 -69 / 通用 -80 / 小红书 -69）。不用注册、不用付费、不用联网、不需要 API Key。默认改写 10 次取 LR 最优的一版（`--best-of-n 0` 可关，恢复单次 5 秒速度）。

---

## 改写前后对比

### 🎓 学术论文（VERY HIGH → LOW，**降 69 分**）
...
### 🌸 社交媒体 → 小红书风格（VERY HIGH → LOW，**降 69 分**）
...
**改写后** 🟢 15分（自动先 humanize 去 AI 词，再加入小红书风格要素）：
> 姐妹们🎀！今天必须分享一下～
>
